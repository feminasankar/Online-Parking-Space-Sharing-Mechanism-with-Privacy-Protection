...
.form-group {
 ...
 <center><h3 style="color:#fff;">User Profile</h3></center>
      <div class="container">
      <?php 
  ...
  <p><b>vehicle Model: </b><?php echo $rows['vehicle_m']; ?></p>
  <p><b>vehicle Number:  </b><?php echo $rows['vehicle_n']; ?></p>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                  <label for="phone_no">vehicle Model:</label>
                  <input type="text" class="form-control" id="phone_no" value="<?php echo $rows['vehicle_m']; ?>" name="vehicle_m">
                </div>
                <div class="form-group">
                  <label for="address">vehicle Number: </label>
                  <input type="text" class="form-control" id="address" value="<?php echo $rows['vehicle_n']; ?>" name="vehicle_n">
                </div>
                <div class="form-group">
