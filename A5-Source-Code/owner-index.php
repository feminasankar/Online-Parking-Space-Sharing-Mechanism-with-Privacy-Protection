...
<body style="background-image:url('../images/ob.jpg')">
  <style type="text/css" style="background-color: #005aa4"></style>
  <ul class="nav nav-pills nav-justified" style="margin-top: -15px;width:25%:padding-left:50px">
  
    
  </ul>
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      <center><h3 style="color: #fff">Owner Profile</h3></center>
      <div class="container" >
        <?php 
        ...
        if(mysqli_num_rows($result)>0)
        {
          while($rows=mysqli_fetch_assoc($result)){
           ...
           <div class="card" style="background-color:#fff;padding:10px">
            ...
            <p><button type="button" class="btn btn-primary"  style="width:50%" data-toggle="modal" data-target="#myModal">Update Profile</button></p>
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <form method="POST" action='addpro-engine.php'>
                      ...
                      <hr>
                      <center><button id="submit" name="owner_update" class="btn btn-primary btn-block" style="background-color: #fff;color: #000;">Update</button></center><br>
                  ...
                  if(mysqli_num_rows($result1)>0)
                  {
                    ...
                    <div id="menu3" class="tab-pane fade">
                      ...
                      <div class="container-fluid">
                        ...
                        </div><body style="background-color: #005aa4">
